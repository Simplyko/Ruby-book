# Задание: удалите все комментарии в программе выше. Способны ли вы разобраться в том, что происходит?
# Задание: добавьте на поле еще 3 собаки.
# Задание: исправьте программу: если все собаки дошли до правого или нижнего края поля, выводить на экран “Win!”
...
loop do
  ...
  win = arr.combination(2).any? do |_a, b|
    if (b.x == 12 || b.y == -12) && b.label == '@'
      puts 'WIN'
      exit
    end
  end
